...
_Last refreshed: 2026-06-29T08:09:55Z (from resource group `RG_JB_NSE_RESULTS_SCREENER`)._

| Fact | Value |
|---|---|
| Subscription | `da4c3e1b-2de5-450b-99be-4c6400c2abdf` |
| Resource group | `RG_JB_NSE_RESULTS_SCREENER` |
| Public URL (FQDN) | http://nse-290626130232.westus2.cloudapp.azure.com |
| Public IP | `40.64.123.144` |
| App Insights appId | `06524a98-5c5a-47ff-a2ac-89badf599417` |
| AI deployment | `NSE_RESULTS_SCREENER_MODEL` on `nse-ai-290626130232` |

### Resources under management
| Component | Name |
|---|---|
| App Service (Node 20) | `app-290626130232` |
| App Service plan | `plan-290626130232` |
| Application Gateway (WAF v2) | `agw-290626130232` |
| Public IP / FQDN | `pip-290626130232 -> nse-290626130232.westus2.cloudapp.azure.com` |
| WAF policy | `waf-290626130232` |
| Virtual network | `vnet-290626130232` |
| Azure SQL server / db | `sql-290626130232 / JBDB` |
| Azure AI / Foundry | `nse-ai-290626130232` |
| Application Insights | `appi-290626130232` |
| Log Analytics | `log-290626130232` |
| Key Vault | `kv-290626130232` |
| Action group | `ag-290626130232` |
