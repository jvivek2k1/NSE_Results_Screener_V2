...
_Last refreshed: 2026-06-28T13:21:17Z (from resource group `rg_nse_results_280626`)._

| Fact | Value |
|---|---|
| Subscription | `da4c3e1b-2de5-450b-99be-4c6400c2abdf` |
| Resource group | `rg_nse_results_280626` |
| Public URL (FQDN) | http://nse-280626172954.westus2.cloudapp.azure.com |
| Public IP | `20.114.1.178` |
| App Insights appId | `f56bed17-142d-4ce3-9eb2-60051ebf05d9` |
| AI deployment | `NSE_RESULTS_SCREENER_MODEL` on `nse-ai-280626172954` |

### Resources under management
| Component | Name |
|---|---|
| App Service (Node 20) | `app-280626172954` |
| App Service plan | `plan-280626172954` |
| Application Gateway (WAF v2) | `agw-280626172954` |
| Public IP / FQDN | `pip-280626172954 -> nse-280626172954.westus2.cloudapp.azure.com` |
| WAF policy | `waf-280626172954` |
| Virtual network | `vnet-280626172954` |
| Azure SQL server / db | `sql-280626172954 / JBDB` |
| Azure AI / Foundry | `nse-ai-280626172954` |
| Application Insights | `appi-280626172954` |
| Log Analytics | `log-280626172954` |
| Key Vault | `kv-280626172954` |
| Action group | `ag-280626172954` |
