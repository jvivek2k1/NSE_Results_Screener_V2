...
_Last refreshed: 2026-06-29T16:50:47Z (from resource group `rg_temp_nse_29626`)._

| Fact | Value |
|---|---|
| Subscription | `da4c3e1b-2de5-450b-99be-4c6400c2abdf` |
| Resource group | `rg_temp_nse_29626` |
| Public URL (FQDN) | http://nse-290626204532.westus2.cloudapp.azure.com |
| Public IP | `20.109.163.218` |
| App Insights appId | `5fbc6be0-4094-4497-bac8-61a7ab82c137` |
| AI deployment | `NSE_RESULTS_SCREENER_MODEL` on `nse-ai-290626204532` |

### Resources under management
| Component | Name |
|---|---|
| App Service (Node 20) | `app-290626204532` |
| App Service plan | `plan-290626204532` |
| Application Gateway (WAF v2) | `agw-290626204532` |
| Public IP / FQDN | `pip-290626204532 -> nse-290626204532.westus2.cloudapp.azure.com` |
| WAF policy | `waf-290626204532` |
| Virtual network | `vnet-290626204532` |
| Azure SQL server / db | `sql-290626204532 / JBDB` |
| Azure AI / Foundry | `nse-ai-290626204532` |
| Application Insights | `appi-290626204532` |
| Log Analytics | `log-290626204532` |
| Key Vault | `kv-290626204532` |
| Action group | `ag-290626204532` |
