...
_Last refreshed: 2026-06-29T00:47:48Z (from resource group `rg_jb_nse_scr_290626`)._

| Fact | Value |
|---|---|
| Subscription | `da4c3e1b-2de5-450b-99be-4c6400c2abdf` |
| Resource group | `rg_jb_nse_scr_290626` |
| Public URL (FQDN) | http://nse-290626052052.westus2.cloudapp.azure.com |
| Public IP | `20.230.180.6` |
| App Insights appId | `63f3c54d-33ff-4c19-ab20-e6bf8e713a8a` |
| AI deployment | `NSE_RESULTS_SCREENER_MODEL` on `nse-ai-290626052052` |

### Resources under management
| Component | Name |
|---|---|
| App Service (Node 20) | `app-290626052052` |
| App Service plan | `plan-290626052052` |
| Application Gateway (WAF v2) | `agw-290626052052` |
| Public IP / FQDN | `pip-290626052052 -> nse-290626052052.westus2.cloudapp.azure.com` |
| WAF policy | `waf-290626052052` |
| Virtual network | `vnet-290626052052` |
| Azure SQL server / db | `sql-290626052052 / JBDB` |
| Azure AI / Foundry | `nse-ai-290626052052` |
| Application Insights | `appi-290626052052` |
| Log Analytics | `log-290626052052` |
| Key Vault | `kv-290626052052` |
| Action group | `ag-290626052052` |
