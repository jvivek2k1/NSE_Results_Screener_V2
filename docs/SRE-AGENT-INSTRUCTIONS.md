...
_Last refreshed: 2026-06-28T16:06:46Z (from resource group `rg_jb_nse2862026`)._

| Fact | Value |
|---|---|
| Subscription | `da4c3e1b-2de5-450b-99be-4c6400c2abdf` |
| Resource group | `rg_jb_nse2862026` |
| Public URL (FQDN) | http://nse-280626202339.westus2.cloudapp.azure.com |
| Public IP | `20.69.153.226` |
| App Insights appId | `80c624a8-d2e6-4d3c-b10e-ec14736fcd59` |
| AI deployment | `NSE_RESULTS_SCREENER_MODEL` on `nse-ai-280626202339` |

### Resources under management
| Component | Name |
|---|---|
| App Service (Node 20) | `app-280626202339` |
| App Service plan | `plan-280626202339` |
| Application Gateway (WAF v2) | `agw-280626202339` |
| Public IP / FQDN | `pip-280626202339 -> nse-280626202339.westus2.cloudapp.azure.com` |
| WAF policy | `waf-280626202339` |
| Virtual network | `vnet-280626202339` |
| Azure SQL server / db | `sql-280626202339 / JBDB` |
| Azure AI / Foundry | `nse-ai-280626202339` |
| Application Insights | `appi-280626202339` |
| Log Analytics | `log-280626202339` |
| Key Vault | `kv-280626202339` |
| Action group | `ag-280626202339` |
